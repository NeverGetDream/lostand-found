...
class M_barang extends CI_Model
{
    ...
    {
        $getdata = "SELECT * FROM barang_hilang LEFT JOIN kategori ON kategori.id_kategori = barang_hilang.id_kategori";
    ...
    {
        $getdata = "SELECT * FROM barang_hilang LEFT JOIN kategori ON kategori.id_kategori = barang_hilang.id_kategori WHERE nama_barang LIKE '%$search%' OR des_barang LIKE '%$search%'";
        $dataraw = $this->db->query($getdata);
        $data = $dataraw->result_array();
        return $data;
    }
    ...
    {
        $getdata = "SELECT * FROM barang_hilang LEFT JOIN kategori ON kategori.id_kategori = barang_hilang.id_kategori WHERE barang_hilang.id_kategori='$id'";
        $dataraw = $this->db->query($getdata);
        $data = $dataraw->result_array();
        return $data;
    }
