...
<script src="<?= base_url('components/'); ?>accordions.js"></script>
		...
		<div class="container mb-5">
			<div class="row">
						...
						<div class="card">
							...
							<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
								<div class="card-body">
									...
									atau
									<a href="<?= base_url('auth/register/') ?>" style="text-decoration: none;"> daftar </a>
				...
				<div class="col-lg-2">
					<div>
						<a href="">
							<img src="<?= base_url('assets/'); ?>img/asking.png" alt="Asking" width="340px">
						</a>
					</div>
				</div>
			</div>
