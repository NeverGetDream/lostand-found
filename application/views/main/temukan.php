                    ...
                    <div class="mt-4 container">
                        <div class="row container mt-2 mb-4" style="align-self: center;">
                            <div class="col-sm-4 container mt-1">
                                <a href=<?= base_url('main/sub_temukan/lost'); ?> style="text-decoration: none;">
                                    <img src="<?= base_url('assets/'); ?>img/lost.png" alt="LOST" width="400px" style="float: right;">
                            ...
                            <div class="col-sm-4 container mt-1">
                                <a href=<?= base_url('main/sub_temukan/found'); ?> style="text-decoration: none;">
