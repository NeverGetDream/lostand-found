                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="form-outline mb-4 col-sm-6">
                                                ...
                                                <input type="text" id="fname" class="form-control form-control-lg" placeholder="Nama Depan" name="fname" />
                                            </div>
                                            <div class="form-outline mb-4 col-sm-6">
                                                <label class="form-label" for="bname">Nama Belakang</label>
                                                <input type="text" id="bname" class="form-control form-control-lg" placeholder="Belakang" name="bname" />
                                            </div>
                                        </div>

                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="email">Email address</label>
                                            <input type="email" id="email" class="form-control form-control-lg" placeholder="Alamat Email" name="email" />
                                        </div>
